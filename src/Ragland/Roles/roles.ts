...
const roles: Role[] = [
...

  {
    ...
    description: [
      "Create and deliver lesson plans for a continually evolving web development curriculum across two programs within the CodeSchool including a MERN (MongoDB, Express, React, and NodeJS) and web fundamentals (HTML/JS/CSS) cohort.",
      " Develop well-documented, full-stack web applications for instructional purposes utilizing technologies outlined in the curriculum for the MERN cohort.",
    ],
  },
];
